...
const ProcessCard = ({ number, icon: Icon, title, description, isLast }) => (
  <div className="relative group">
    {/* Connector Line */}
    {!isLast && (
      <div className="hidden lg:block absolute top-20 left-full w-full h-[2px] bg-gradient-to-r from-teal-600/20 to-teal-600/0 z-0">
        <div className="absolute top-1/2 left-1/2 w-4 h-4 bg-teal-600 rounded-full transform -translate-x-1/2 -translate-y-1/2
    ...
    <div className="relative bg-white rounded-[32px] p-8 z-10 group-hover:shadow-2xl transition-all duration-500
                    border border-teal-50 hover:-translate-y-2">
      {/* Number Badge */}
      <div className="absolute -top-6 left-8">
        <div className="relative">
          <div className="w-12 h-12 bg-teal-600 rounded-2xl flex items-center justify-center text-white font-bold text-xl
                        transform group-hover:rotate-12 transition-transform duration-500">
            {number}
          </div>
          <div className="absolute inset-0 bg-teal-600 rounded-2xl blur opacity-40 group-hover:opacity-60 transition-opacity duration-500"></div>
        </div>
      </div>
  ...
  return (
    <section id="process" className="relative py-32 overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute top-40 left-0 w-96 h-96 bg-teal-600/5 rounded-full blur-3xl"></div>
      ...
      <div className="max-w-[1600px] mx-auto px-8 lg:px-16 relative">
        ...
        <div className="text-center mb-20">
          ...
          <h2 className="text-4xl md:text-5xl font-bold mb-4">
            How To Work <span className="text-teal-600">It!</span>
          </h2>
        </div>
